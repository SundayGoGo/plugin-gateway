(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
    ["app"], {
        ...
        1779: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    use: "icon-bug-usage",
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-bug"><defs><style type="text/css"></style></defs><path d="M969.142857 548.571429q0 14.848-10.861714 25.709714t-25.709714 10.861714l-128 0q0 97.718857-38.290286 165.705143l118.857143 119.442286q10.861714 10.861714 10.861714 25.709714t-10.861714 25.709714q-10.276571 10.861714-25.709714 10.861714t-25.709714-10.861714l-113.152-112.566857q-2.852571 2.852571-8.557714 7.424t-23.990857 16.274286-37.156571 20.845714-46.848 16.566857-55.442286 7.424l0-512-73.142857 0 0 512q-29.147429 0-58.002286-7.716571t-49.700571-18.870857-37.705143-22.272-24.868571-18.578286l-8.557714-8.009143-104.557714 118.272q-11.446857 11.995429-27.428571 11.995429-13.714286 0-24.576-9.142857-10.861714-10.276571-11.702857-25.417143t8.850286-26.587429l115.419429-129.718857q-33.133714-65.133714-33.133714-156.562286l-128 0q-14.848 0-25.709714-10.861714t-10.861714-25.709714 10.861714-25.709714 25.709714-10.861714l128 0 0-168.009143-98.852571-98.852571q-10.861714-10.861714-10.861714-25.709714t10.861714-25.709714 25.709714-10.861714 25.709714 10.861714l98.852571 98.852571 482.304 0 98.852571-98.852571q10.861714-10.861714 25.709714-10.861714t25.709714 10.861714 10.861714 25.709714-10.861714 25.709714l-98.852571 98.852571 0 168.009143 128 0q14.848 0 25.709714 10.861714t10.861714 25.709714zM694.857143 219.428571l-365.714286 0q0-75.995429 53.430857-129.426286t129.426286-53.430857 129.426286 53.430857 53.430857 129.426286z" p-id="10315" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
            ...
            var i = {
                ...
                a = {
                    GB28181: {
                        ...
                        Realm: "Server（SIP）的域",
                        ListenAddr: "ListenAddr是监听的地址，这里需要注意的是必须要带上Server的IP地址，这个IP地址是向设备发送信息的时候需要带上的。",
                        Expires: "设备连接超时时间",
                        AutoCloseAfter: "如果设置大于等于0，则当某个流最后一个订阅者取消订阅时会延迟N秒，会自动发送bye，节省流量。如果为了响应及时，可以设置成-1，保持流的连接",
                        MediaPort: "表示用于接收设备流的端口号",
                        AutoInvite: "AutoInvite 表示自动发起invite，当Server（SIP）接收到设备信息时，立即向设备发送invite命令获取流",
                        ...
                        mainTips: ["该插件提供SIP server的服务，以及流媒体服务器能力，可以将NVR和摄像头的流抓到m7s中，可获取的设备的录像数据以及访问录像视频。也可以控制摄像头的旋转、缩放等。", "注意某些摄像机没有设置用户名的地方，摄像机会以自身的国标id作为用户名，这个时候m7s会忽略使用摄像机的用户名，忽略配置的用户名 如果设备配置了错误的用户名和密码，连续三次上报错误后，m7s会记录设备id，并在10分钟内禁止设备注册"]
                    },
                    GateWay: {
                    ...
                    HDL: {
                        ...
                        mainTips: ["HDL.AutoPullList 自动拉流，可以设置多个，key为流唯一标识，value为拉流地址"]
                    },
                    HLS: {
                        Fragment: "分片大小，单位秒",
                        Window: "窗口，即每个m3u8中包含几个ts",
                        EnableWrite: "用来控制是否启用HLS文件写入功能",
                        EnableMemory: "用来启用内存播放模式，开启后ts数据会保存在内存中, 如果同时开启写入和内存模式的话，从gateway读取的ts会优先使用内存",
                        Path: "HLS文件存放文件夹地址"
                    },
                    Jessica: {
                        ListenAddr: "是监听的地址，如果配置为空字符串，则是复用Gateway插件监听的公共端口",
                    ...
                    LogRotate: {
                        Path: "生成日志的目录",
                        Size: "按大小分割",
                        Days: "单位是字节，如果为0，则按时间分割 Days代表按时间分割，单位是天，即24小时 Formatter日志文件名格式化",
                        Formatter: "按照go layout格式化，默认按照小时"
                    },
                    RTMP: {
                        ListenAddr: "监听的地址",
                        ChunkSize: "分块大小"
                    ...
                    RTSP: {
                        ...
                        Timeout: "",
                        Reconnect: "否自动重连",
                        mainTips: ["当自动拉流列表中当的streamPath为sub/xxx 这种形式的话，在gb28181的分屏显示时会优先采用rtsp流，已实现分屏观看子码流效果。", "RTSP.AutoPullList 可以配置多项，用于自动拉流，key是streamPath，value是远程rtsp地址"]
                    },
                    Record: {
                        Path: "要保存的Flv文件的根路径，可以使用相对路径或者绝对路径",
                        AutoRecord: "",
                        mainTips: ["实现了录制Flv文件的功能，并且支持再次使用录制好的Flv文件作为发布者进行发布。"]
                    },
                    Summary: {
                    ...
                    TS: {
                        BufferLength: "解析TS流的时候的缓存大小，单位是PES包的个数",
                        Path: "指存放ts的目录"
                    },
                    WebRTC: {
                        PublicIP: "如果需要公网访问，需要配置公网IP，本机测试不需要配置",
                        PortMin: "端口范围最小值，端口范围不配置的话是自动分配",
                        PortMax: "端口范围最大值，端口范围不配置的话是自动分配",
                        PLI: ""
                    }
                }
        },
        2580: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    content: '<symbol class="icon" viewBox="0 0 1088 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-language"><defs><style type="text/css"></style></defs><path d="M729.6 294.4c19.2 57.6 44.8 102.4 89.6 147.2 38.4-38.4 64-89.6 83.2-147.2h-172.8zM307.2 614.4h166.4L390.4 390.4z" p-id="6280" /><path d="M947.2 0h-768C108.8 0 51.2 57.6 51.2 128v768c0 70.4 57.6 128 128 128h768c70.4 0 128-57.6 128-128V128c0-70.4-51.2-128-128-128zM633.6 825.6c-12.8 12.8-25.6 12.8-38.4 12.8-6.4 0-19.2 0-25.6-6.4s-12.8 0-12.8-6.4-6.4-12.8-12.8-25.6-6.4-19.2-12.8-32l-25.6-70.4H281.6L256 768c-12.8 25.6-19.2 44.8-25.6 57.6-6.4 12.8-19.2 12.8-38.4 12.8-12.8 0-25.6-6.4-38.4-12.8-12.8-12.8-19.2-19.2-19.2-32 0-6.4 0-12.8 6.4-25.6s6.4-19.2 12.8-32l140.8-358.4c6.4-12.8 6.4-25.6 12.8-38.4s12.8-25.6 19.2-32 12.8-19.2 25.6-25.6c12.8-6.4 25.6-6.4 38.4-6.4 12.8 0 25.6 0 38.4 6.4 12.8 6.4 19.2 12.8 25.6 25.6 6.4 6.4 12.8 19.2 19.2 32 6.4 12.8 12.8 25.6 19.2 44.8l140.8 352c12.8 25.6 19.2 44.8 19.2 57.6-6.4 6.4-12.8 19.2-19.2 32zM985.6 576c-70.4-25.6-121.6-57.6-166.4-96-44.8 44.8-102.4 76.8-172.8 96l-19.2-32c70.4-19.2 128-44.8 172.8-89.6-44.8-44.8-83.2-102.4-96-166.4h-64v-25.6h172.8c-12.8-19.2-25.6-44.8-38.4-64l19.2-6.4c12.8 19.2 32 44.8 44.8 70.4h160v32h-64c-19.2 64-51.2 121.6-89.6 160 44.8 38.4 96 70.4 166.4 89.6l-25.6 32z" p-id="6281" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        ...
        3046: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-money"><defs><style type="text/css"></style></defs><path d="M463.3 958.3V772.1H228.8v-77.5h234.5v-80.5H228.8v-83.5H420L191.5 128h113.7L469 420.6c18.2 33.4 32.4 62.4 42.7 86.9 9-19.8 24.6-50.5 46.8-92.1L713.9 128h120.8L605.5 530.6h192.9v83.5H564.9v80.5h233.5v77.5H564.9v186.2H463.3z" p-id="1765" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        "30c3": function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-example"><defs><style type="text/css"></style></defs><path d="M770.56 460.8l250.88 0C998.4 220.16 803.84 25.6 563.2 2.56l0 250.88C668.16 273.92 750.08 355.84 770.56 460.8L770.56 460.8zM770.56 460.8" p-id="9879" /><path d="M460.8 253.44 460.8 2.56C220.16 25.6 25.6 220.16 2.56 460.8l250.88 0C273.92 355.84 355.84 273.92 460.8 253.44L460.8 253.44zM460.8 253.44" p-id="9880" /><path d="M563.2 770.56l0 250.88c243.2-23.04 435.2-217.6 460.8-460.8l-250.88 0C750.08 668.16 668.16 750.08 563.2 770.56L563.2 770.56zM563.2 770.56" p-id="9881" /><path d="M253.44 563.2 2.56 563.2c23.04 243.2 217.6 435.2 460.8 460.8l0-250.88C355.84 750.08 273.92 668.16 253.44 563.2L253.44 563.2zM253.44 563.2" p-id="9882" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
                ...
                d = new o["a"].Store({
                    ...
                    mutations: {
                        TOGGLE_SIDEBAR: function (t) {
                            t.sidebar.opened ? c.sidebarStatus = !0 : c.sidebarStatus = !1, t.sidebar.opened = !t.sidebar.opened, t.sidebar.withoutAnimation = !1
                        },
                        CLOSE_SIDEBAR: function (t, e) {
                            c.sidebarStatus = !0, t.sidebar.opened = !1, t.sidebar.withoutAnimation = e
                        },
                    ...
                    actions: {
                        ...
                        fetchEngineInfo: function (t) {
                            var e = t.commit;
                            return r["l"]().then((function (t) {
                                return e("UPDATE", {
                                    engineInfo: t
                                })
                            }))
                        },
                        fetchPlugins: function (t) {
                            var e = t.commit;
                            return r["h"]().then((function (t) {
                                t.sort((function (t, e) {
                                ...
                                var n = (t || []).find((function (t) {
                                    return "GB28181" === t.Name
                                }));
                                if (n) {
                                    var i = Object(s["w"])(n.Config),
                                        o = "true" === i.AutoInvite || !0 === i.AutoInvite;
                                    e("UPDATE", {
                                        gb28181AutoInvite: o
                                    })
                                }
                        ...
                        fetchSummary: function (t) {
                            var e = t.commit;
                            l || (l = r["k"](), l.onmessage = function (t) {
                                if (t.data) {
                                    var n = JSON.parse(t.data);
                                    n.Address = location.hostname, n.Streams || (n.Streams = []), n.Streams.sort((function (t, e) {
                                        return t.StreamPath > e.StreamPath ? 1 : -1
                                    })), n.updateTimestamp = (new Date).getTime(), e("UPDATE", n)
                                }
                        ...
                        fetchGb28181: function (t) {
                            var e = t.commit;
                            u || (u = r["e"](), u.onmessage = function (t) {
                                if (t.data) {
                                    var n = JSON.parse(t.data);
                                    if (Array.isArray(n)) {
                                        n.sort((function (t, e) {
                                        ...
                                        n.forEach((function (t) {
                                            var e = t.Channels || [];
                                            e.length > 0 && (i = i.concat(e.map((function (e, n) {
                                                return e.device = t, e.channel = n, e
                                            }))))
                                        })), i = i.filter((function (t) {
                                            return !!t.DeviceID
                                        })), e("UPDATE", {
                                            Gb28181List: n,
                                            Gb28181ChannelList: i
                                        })
                                    }
                                }
                    ...
                    getters: {
                        getConfig: function (t) {
                            return function (e) {
                                var n = null,
                                    i = t.plugins.find((function (t) {
                                        return t.Name === e
                                    }));
                                return i && (n = Object(s["w"])(i.Config)), n
                            }
                        }
                    }
                });
        ...
        "47ff": function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-message"><defs><style type="text/css"></style></defs><path d="M0 202.7V631c0 83.3 68.3 150.7 152.6 150.7h228.9l8 190.3 224.9-190.3h257c84.3 0 152.6-67.4 152.6-150.7V202.7C1024 119.4 955.7 52 871.4 52H152.6C68.3 52 0 119.4 0 202.7z m658.6 237.9c0-39.7 32.1-71.4 72.3-71.4 40.2 0 72.3 31.7 72.3 71.4S771 512 730.9 512c-40.2 0-72.3-31.7-72.3-71.4z m-220.9 0c0-39.7 32.1-71.4 72.3-71.4 40.2 0 72.3 31.7 72.3 71.4S550.1 512 510 512c-40.2 0-72.3-31.7-72.3-71.4z m-216.8 0c0-39.7 32.1-71.4 72.3-71.4 40.2 0 72.3 31.7 72.3 71.4S333.3 512 293.1 512c-40.1 0-72.2-31.7-72.2-71.4z" p-id="2027" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        ...
        "4ec3": function (t, e, n) {
            ...
            var d = "/api",
                p = "".replace("http://", "ws://").replace("https://", "wws://") + "/jessica/",
                f = "",
                h = "http:" === location.protocol ? "ws:" : "wss:",
                m = {
                    rtspHref: "rtsp://".concat(location.host, "/"),
                    rtmpHref: "rtmp://".concat(location.host, "/"),
                    hlsHref: Object(i["r"])() ? f + "/hls/" : "".concat(location.protocol, "//").concat(location.host, "/hls/"),
                    hdlHref: Object(i["r"])() ? f + "/hdl/" : "".concat(location.protocol, "//").concat(location.host, "/hdl/"),
                    baseHref: Object(i["r"])() ? f : "".concat(location.protocol, "://").concat(location.host),
                    jessibucaHref: Object(i["r"])() ? p : "".concat(h, "//").concat(location.host, "/jessica/"),
                    recordHref: Object(i["r"])() ? f + "/vod/" : "".concat(location.protocol, "//").concat(location.host, "/vod/"),
                    fetchSysInfo: d + "/gateway/sysInfo",
                    fetchPlugins: d + "/gateway/plugins",
                    fetchLogList: d + "/logrotate/list",
                    fetchLogTail: d + "/logrotate/tail",
                    searchLog: d + "/logrotate/find",
                    logOpenHref: d + "/logrotate/open?file=",
                    logDownloadHref: d + "/logrotate/download?file=",
                    fetchRecordList: d + "/record/flv/list",
                    deleteRecordItem: d + "/record/flv/delete",
                    stopRecordFlv: d + "/record/flv/stop",
                    playRecordFlv: d + "/record/flv/play",
                    recordFlv: d + "/record/flv",
                    fetchSummary: d + "/summary",
                    fetchGb28181: d + "/gb28181/list",
                    fetchRtsp: d + "/rtsp/list",
                    fetchHls: d + "/hls/list",
                    fetchHdl: d + "/hdl/list",
                    relayRtsp: d + "/rtsp/pull",
                    relayHLS: d + "/hls/pull",
                    relayHdl: d + "/hdl/pull",
                    getWebRtcRemoteSdp: d + "/webrtc/play",
                    inviteGb28181: d + "/gb28181/invite",
                    byeGb28181: d + "/gb28181/bye",
                    ptzCmdGb28181: d + "/gb28181/control",
                    queryRecords: d + "/gb28181/query/records",
                    playRecords: d + "/gb28181/invite",
                    stopRecords: d + "/gateway/stop",
                    printStream: d + "/gateway/print"
                },
                w = m,
                v = w;
            ...
            function y() {
                return new EventSource(w.fetchLogTail)
            }
            ...
            function C(t) {
                return u({
                    url: w.deleteRecordItem,
                    method: "get",
                    params: {
                        streamPath: t.replace(".flv", "")
                    }
                })
            }
            ...
            function z() {
                return new EventSource(w.fetchSummary)
            }

            function O() {
                return new EventSource(w.fetchGb28181)
            }

            function q(t) {
                return new EventSource(w.printStream + "?" + t)
            }

            function _(t, e) {
                return u({
                    url: w.getWebRtcRemoteSdp,
                    method: "POST",
                    params: {
                        streamPath: t
                    },
            ...
            function E() {
                return new EventSource(w.fetchRtsp)
            }

            function R() {
                return new EventSource(w.fetchHls)
            }

            function I() {
                return new EventSource(w.fetchHdl)
            }
        ...
        "51ff": function (t, e, n) {
            ...
            }, o.resolve = r, t.exports = o, o.id = "51ff"
        },
        "56d6": function (t, e, n) {
            "use strict";
            n.r(e);
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-component"><defs><style type="text/css"></style></defs><path d="M64 64 448 64 448 448 64 448 64 64ZM64 576 448 576 448 960 64 960 64 576ZM576 576 960 576 960 960 576 960 576 576ZM768 448C874.038669 448 960 362.038672 960 256 960 149.961328 874.038669 64 768 64 661.961328 64 576 149.961328 576 256 576 362.038672 661.961328 448 768 448Z" p-id="1662" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        "56d7": function (t, e, n) {
            ...
            n.r(e);
            var i = {};
            n.r(i), n.d(i, "parseTimeFilter", (function () {
                return F["v"]
            })), n.d(i, "formatPassTimeFilter", (function () {
                return F["d"]
            })), n.d(i, "unitSpeedFormatFilter", (function () {
                return F["x"]
            })), n.d(i, "formatDurationTimeFilter", (function () {
                return F["b"]
            })), n.d(i, "formatRemainTimeFilter", (function () {
                return F["e"]
            })), n.d(i, "formatMinTimeTipsFilter", (function () {
                return F["c"]
            })), n.d(i, "soundFormatFilter", (function () {
                return qt
            })), n.d(i, "codecIDFilter", (function () {
                return _t
            })), n.d(i, "soundRateFilter", (function () {
                return Bt
            }));
            ...
            var o = n("2b0e"),
                ...
                l = {
                    name: "app",
                    created: function () {
                        this.$store.dispatch("fetchEngineInfo"), this.$store.dispatch("fetchPlugins"), this.$store.dispatch("fetchSummary"), this.$store.dispatch("fetchGb28181")
                    },
                    destroyed: function () {
                ...
                u = l,
                d = n("2877"),
                p = Object(d["a"])(u, a, c, !1, null, "538cc079", null),
                f = p.exports,
                h = (n("b20f"), n("8c4f")),
                m = function () {
                    var t = this,
                    ...
                    }, [n("navbar"), t._v(" "), n("app-main"), t._v(" "), t._m(0)], 1)], 1)
                },
                w = [function () {
                    var t = this,
                        e = t.$createElement,
                ...
                b = function () {
                    ...
                    return n("el-menu", {
                        ...
                        staticClass: "network right-menu-item"
                    }, [n("div", [t._v("发送"), n("i", {
                        staticClass: "el-icon-top"
                    }), t._v(" : "), n("span", [t._v(t._s(t.totalSentSpeed) + "/s")])]), t._v(" "), n("div", [t._v("接受"), n("i", {
                        staticClass: "el-icon-bottom"
                    }), t._v(" : "), n("span", [t._v(t._s(t.totalReceiveSpeed) + "/s")])])]), t._v(" "), t.startTime ? n("el-tooltip", {
                        attrs: {
                            effect: "light",
                            placement: "bottom"
                        }
                        ...
                        slot: "content"
                    }, [t._v(t._s(t._f("parseTimeFilter")(t.startTime)))]), t._v(" "), n("span", [t._v("启动时间: "), n("el-tag", {
                        attrs: {
                            type: "success"
                        }
                    }, [t._v(t._s(t._f("formatPassTimeFilter")(t.startTime)))])], 1)]) : t._e(), t._v(" "), n("el-tooltip", {
                        attrs: {
                            effect: "dark",
                            content: "全屏",
                            placement: "bottom"
                ...
                y = function () {
                    ...
                    }, t._l(t.levelList, (function (e, i) {
                        return e.meta.title ? n("el-breadcrumb-item", {
                            key: e.path
                        }, ["noredirect" === e.redirect || i == t.levelList.length - 1 ? n("span", {
                            staticClass: "no-redirect"
                        }, [t._v(t._s(e.meta.title))]) : n("router-link", {
                            attrs: {
                                to: e.redirect || e.path
                            }
                        }, [t._v(t._s(e.meta.title))])], 1) : t._e()
                    })), 1)], 1)
                },
                M = [],
                k = (n("7f7f"), {
                    ...
                    methods: {
                        getBreadcrumb: function () {
                            var t = this.$route.matched.filter((function (t) {
                                ...
                                e = t[0];
                            e && e.meta && e.meta.parent && (t = [e.meta.parent].concat(t)), this.levelList = t
                        }
                    }
                }),
                C = k,
                L = (n("0650"), Object(d["a"])(C, y, M, !1, null, "16b2fb2a", null)),
                S = L.exports,
                z = function () {
                    var t = this,
                        e = t.$createElement,
                ...
                _ = q,
                B = (n("4c5d"), Object(d["a"])(_, z, O, !1, null, "abf990d6", null)),
                P = B.exports,
                j = function () {
                    var t = this,
                        e = t.$createElement,
                ...
                H = {
                    ...
                    methods: {
                        click: function () {
                            if (!D.a.enabled) return this.$message({
                ...
                E = H,
                R = (n("5ffa"), Object(d["a"])(E, j, A, !1, null, "2e0e720e", null)),
                I = R.exports,
                F = n("ed08");
            ...
            var V = {
                    ...
                    computed: N(N({}, Object(g["b"])({
                        sidebar: function (t) {
                            return t.sidebar
                        },
                        startTime: function (t) {
                            var e = t.engineInfo.StartTime;
                        ...
                        totalSentSpeed: function () {
                            var t = 0;
                            return this.netWorkList.forEach((function (e) {
                                t += e.SentSpeed || 0
                            })), Object(F["x"])(t)
                        },
                        totalReceiveSpeed: function () {
                            var t = 0;
                            return this.netWorkList.forEach((function (e) {
                                t += e.ReceiveSpeed || 0
                            })), Object(F["x"])(t)
                ...
                Z = V,
                $ = (n("049b"), Object(d["a"])(Z, b, x, !1, null, "0a2f2185", null)),
                U = $.exports,
                W = function () {
                    var t = this,
                        e = t.$createElement,
                    ...
                    return n("el-scrollbar", {
                        ...
                        staticClass: "api-small"
                    })]), t._v(" "), n("el-menu", {
                        attrs: {
                            mode: "vertical",
                            "show-timeout": 200,
                            "default-active": t.needActive(),
                ...
                K = function () {
                    ...
                    return n("div", {
                        ...
                        return !e.hidden && e.children ? [!t.hasOneShowingChildren(e.children) || e.children[0].children || e.alwaysShow ? n("el-submenu", {
                            key: e.name,
                            attrs: {
                                index: e.name || e.path
                            }
                            ...
                            slot: "title"
                        }, [e.meta && e.meta.icon ? n("svg-icon", {
                            attrs: {
                                "icon-class": e.meta.icon
                            }
                        }) : t._e(), t._v(" "), e.meta && e.meta.title ? n("span", {
                            attrs: {
                                slot: "title"
                            },
                            slot: "title"
                        }, [t._v(t._s(e.meta.title))]) : t._e()], 1), t._v(" "), t._l(e.children, (function (i) {
                            return i.hidden ? t._e() : [i.children && i.children.length > 0 ? n("sidebar-item", {
                                key: i.path,
                            ...
                            }, [i.meta && i.meta.icon ? n("svg-icon", {
                                attrs: {
                                    "icon-class": i.meta.icon
                                }
                            }) : t._e(), t._v(" "), i.meta && i.meta.title ? n("span", {
                                attrs: {
                                    slot: "title"
                                },
                                slot: "title"
                            }, [t._v(t._s(i.meta.title))]) : t._e()], 1)], 1)]
                        }))], 2) : n("router-link", {
                            key: e.children[0].name,
                            attrs: {
                                to: e.path + "/" + e.children[0].path
                            }
                        }, [n("el-menu-item", {
                            attrs: {
                                index: e.path + "/" + e.children[0].path
                            }
                        }, [e.children[0].meta && e.children[0].meta.icon ? n("svg-icon", {
                            attrs: {
                                "icon-class": e.children[0].meta.icon
                            }
                        }) : t._e(), t._v(" "), e.children[0].meta && e.children[0].meta.title ? n("span", {
                            attrs: {
                                slot: "title"
                            },
                            slot: "title"
                        }, [t._v(t._s(e.children[0].meta.title))]) : t._e()], 1)], 1)] : t._e()
                    }))], 2)
                },
                Y = [],
                Q = {
                ...
                X = Q,
                tt = Object(d["a"])(X, K, Y, !1, null, null, null),
                et = tt.exports;
            ...
            var ot = {
                    ...
                    data: function () {
                        return {
                            constantRouterMap: St
                        }
                    },
                    components: {
                        SidebarItem: et
                    },
                    computed: it({}, Object(g["b"])({
                        sidebar: function (t) {
                            return t.sidebar
                        },
                        ...
                        version: function (t) {
                            return t.engineInfo.Version
                        }
                    })),
                    methods: {
                        needActive: function () {
                            return this.$route.meta && this.$route.meta.parent ? this.$route.meta.parent && this.$route.meta.parent.path : this.$route.path
                        }
                    }
                },
                rt = ot,
                st = (n("5b30"), Object(d["a"])(rt, W, J, !1, null, "27fe2687", null)),
                at = st.exports,
                ct = function () {
                    var t = this,
                        e = t.$createElement,
                ...
                dt = ut,
                pt = (n("22dd"), Object(d["a"])(dt, ct, lt, !1, null, "40080ad0", null)),
                ft = pt.exports,
                ht = n("4360"),
                mt = document,
                wt = mt.body,
                ...
                bt = {
                    watch: {
                        $route: function (t) {
                            "mobile" === this.device && this.sidebar.opened && ht["a"].dispatch("closeSideBar", {
                                withoutAnimation: !1
                            })
                        }
                    },
                    ...
                    mounted: function () {
                        var t = this.isMobile();
                        t && (ht["a"].dispatch("toggleDevice", "mobile"), ht["a"].dispatch("closeSideBar", {
                            withoutAnimation: !0
                        }))
                    },
                    methods: {
                        isMobile: function () {
                            var t = wt.getBoundingClientRect();
                            return t.width - gt < vt
                        },
                        resizeHandler: function () {
                            if (!document.hidden) {
                                var t = this.isMobile();
                                ht["a"].dispatch("toggleDevice", t ? "mobile" : "desktop"), t && ht["a"].dispatch("closeSideBar", {
                                    withoutAnimation: !0
                                })
                            }
                        }
            ...
            var Mt = {
                ...
                kt = Mt,
                Ct = (n("748b"), Object(d["a"])(kt, m, w, !1, null, "38550049", null)),
                Lt = Ct.exports,
                St = [{
                    path: "/404",
                    component: function () {
                        return n.e("chunk-2d0b309a").then(n.bind(null, "2754"))
                    },
                    hidden: !0
                }, {
                    path: "",
                    ...
                    children: [{
                        path: "home",
                        component: function () {
                            return Promise.all([n.e("chunk-4bc5e06a"), n.e("chunk-6b0dfb08")]).then(n.bind(null, "7abe"))
                        },
                        name: "home",
                        meta: {
                            title: "监控面板",
                    ...
                    children: [{
                        path: "index",
                        component: function () {
                            return Promise.all([n.e("chunk-3f7bc161"), n.e("chunk-5bceb546")]).then(n.bind(null, "e7d7"))
                        },
                        name: "stream",
                        meta: {
                            title: "流列表",
                    ...
                    children: [{
                        path: "index",
                        component: function () {
                            return Promise.all([n.e("chunk-6e83591c"), n.e("chunk-3135f334")]).then(n.bind(null, "0e54"))
                        },
                        name: "gb28181",
                        meta: {
                            title: "设备管理",
                    ...
                    children: [{
                        path: "index",
                        component: function () {
                            return Promise.all([n.e("chunk-3f7bc161"), n.e("chunk-523a6471")]).then(n.bind(null, "18ad"))
                        },
                        name: "square",
                        meta: {
                            title: "视频广场",
                    ...
                    children: [{
                        path: "index",
                        component: function () {
                            return Promise.all([n.e("chunk-3f7bc161"), n.e("chunk-6e83591c"), n.e("chunk-64454064")]).then(n.bind(null, "7fa6"))
                        },
                        name: "screen",
                        meta: {
                            title: "分屏展示",
                    ...
                    children: [{
                        path: "index",
                        component: function () {
                            return n.e("chunk-2d0c76e6").then(n.bind(null, "511e"))
                        },
                        name: "relays",
                        meta: {
                            title: "拉流转发",
                    ...
                    children: [{
                        path: "index",
                        component: function () {
                            return Promise.all([n.e("chunk-3f7bc161"), n.e("chunk-3275610d")]).then(n.bind(null, "caae"))
                        },
                        name: "record",
                        meta: {
                            title: "录像回看",
                    ...
                    children: [{
                        path: "index",
                        component: function () {
                            return n.e("chunk-e0abfed4").then(n.bind(null, "be69"))
                        },
                        name: "logs",
                        meta: {
                            title: "操作日志",
                    ...
                    children: [{
                        path: "index",
                        component: function () {
                            return n.e("chunk-8f664142").then(n.bind(null, "eb43"))
                        },
                        name: "config",
                        meta: {
                            title: "配置信息",
                    ...
                    children: [{
                        path: "index",
                        component: function () {
                            return n.e("chunk-2d0ceb84").then(n.bind(null, "613f"))
                        },
                        name: "about",
                        meta: {
                            title: "版本信息",
            ...
            function Bt(t) {
                return Object(F["s"])(t) ? "" : t > 1e3 ? t / 1e3 + "kHz" : t + "Hz"
            }
            var Pt = n("323e"),
                jt = n.n(Pt);
            n("a5d8");
            ...
            zt.beforeEach((function (t, e, n) {
                jt.a.start(), n()
            })), zt.afterEach((function () {
                jt.a.done()
            }));
            var At = function () {
                    var t = this,
                ...
                Dt = {
                    ...
                    computed: {
                        isSvg: function () {
                            return this.iconClass && -1 === this.iconClass.indexOf("-icon-")
                        },
                        iconName: function () {
                            return this.iconClass && -1 !== this.iconClass.indexOf("-icon-") ? "".concat(this.iconClass) : "#icon-".concat(this.iconClass)
                        },
                        svgClass: function () {
                ...
                Ht = Dt,
                Et = (n("d2ad"), Object(d["a"])(Ht, At, Tt, !1, null, "8ecbe8e8", null)),
                Rt = Et.exports;
            o["default"].component("svg-icon", Rt);
            var It = function (t) {
                    return t.keys().map(t)
                },
                Ft = n("51ff");
            It(Ft), o["default"].use(s.a, {
                size: "small"
        ...
        6599: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-excel"><defs><style type="text/css"></style></defs><path d="M625.664 132.608V199.68h309.76v43.008h-309.76V312.32h309.76v43.008h-309.76v68.608h309.76v43.008h-309.76v68.608h309.76v43.008h-309.76v68.608h309.76v43.008h-309.76v68.096h309.76v43.008h-309.76v89.088H1024v-757.76h-398.336zM0 914.944L577.024 1024V0L0 109.056" p-id="10098" /><path d="M229.376 660.48H139.776l118.272-187.904-112.64-180.736h92.16l65.536 119.808L370.688 291.84h89.088l-112.64 177.664L466.944 660.48H373.248l-70.144-125.44L229.376 660.48z" p-id="10099" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        6683: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    content: '<symbol class="icon" viewBox="0 0 1117 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-guide"><defs><style type="text/css"></style></defs><path d="M53.865 558.08l289.92 121.6 560-492.16-491.52 530.56 371.84 140.8c8.96 3.2 19.2-1.28 22.4-10.24V848l260.48-816.64-1014.4 494.72c-8.96 4.48-12.16 14.72-8.32 23.68 2.56 3.84 5.76 7.04 9.6 8.32z m357.76 434.56l144.64-155.52-144.64-58.88v214.4z" p-id="10275" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        ...
        "8fb7": function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    use: "icon-tab-usage",
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-tab"><defs><style type="text/css"></style></defs><path d="M622.276923 39.384615H401.723077c-13.784615 0-23.630769 11.815385-23.630769 25.6v49.23077c0 13.784615 11.815385 25.6 23.630769 25.6h220.553846c13.784615 0 23.630769-11.815385 23.630769-25.6V64.984615c1.969231-13.784615-9.846154-25.6-23.630769-25.6z m336.738462 0H738.461538c-13.784615 0-25.6 11.815385-25.6 25.6v49.23077c0 13.784615 11.815385 25.6 25.6 25.6h220.553847c13.784615-1.969231 25.6-11.815385 25.6-25.6V64.984615c0-13.784615-11.815385-25.6-25.6-25.6z m0 165.415385H334.769231c-13.784615 0-25.6-11.815385-25.6-25.6V64.984615c0-13.784615-11.815385-25.6-25.6-25.6H64.984615C51.2 39.384615 39.384615 51.2 39.384615 64.984615v896c0 11.815385 11.815385 23.630769 25.6 23.63077h894.03077c13.784615 0 25.6-11.815385 25.6-25.6v-728.615385c0-13.784615-11.815385-25.6-25.6-25.6z" p-id="1385" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        "90fb": function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-documentation"><defs><style type="text/css"></style></defs><path d="M554.666667 384h234.666666L554.666667 149.333333V384M256 85.333333h341.333333l256 256v512a85.333333 85.333333 0 0 1-85.333333 85.333334H256a85.333333 85.333333 0 0 1-85.333333-85.333334V170.666667c0-47.36 37.973333-85.333333 85.333333-85.333334m384 682.666667v-85.333333H256v85.333333h384m128-170.666667v-85.333333H256v85.333333h512z" fill="" p-id="5673" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        ...
        "9d91": function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    use: "icon-icon-usage",
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-icon"><defs><style type="text/css"></style></defs><path d="M871.424 61.44q18.432 0 34.816 6.656t28.672 18.944 19.456 28.672 7.168 35.84l0 720.896q0 38.912-25.088 64.512t-62.976 25.6l-721.92 0q-40.96 0-66.048-26.624t-25.088-66.56l0-718.848q0-35.84 24.576-62.464t65.536-26.624l720.896 0zM633.856 829.44q18.432 0 26.624-8.704t8.192-23.04q0-13.312-8.192-22.528t-26.624-9.216l-62.464 0q1.024-2.048 1.024-6.144l0-507.904 63.488 0q18.432 0 25.6-9.216t7.168-22.528-7.168-22.528-25.6-9.216l-249.856 0q-18.432 0-25.6 9.216t-7.168 22.528 7.168 22.528 25.6 9.216l57.344 0 0 507.904q0 2.048 0.512 3.072t0.512 3.072l-56.32 0q-18.432 0-26.624 9.216t-8.192 22.528q0 14.336 8.192 23.04t26.624 8.704l245.76 0z" p-id="14765" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        ...
        aa46: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    use: "icon-edit-usage",
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-edit"><defs><style type="text/css"></style></defs><path d="M860 504c-19.9 0-36 16.1-36 36 0 1.4 0.1 2.7 0.2 4h-0.2v344H136V200h376c19.9 0 36-16.1 36-36s-16.1-36-36-36H136c-39.8 0-72 32.2-72 72v688c0 39.8 32.2 72 72 72h688c39.8 0 72-32.2 72-72V544h-0.2c0.1-1.3 0.2-2.6 0.2-4 0-19.9-16.1-36-36-36z" p-id="2920" /><path d="M1002.7 100.3L923.4 21c-28.1-28.1-73.9-27.9-102 0.2L424.2 418.4c-2.9 2.9-5.2 6.4-6.8 10.2L317.6 664c-5.6 13.2-1.7 26.5 6.8 35.1 8.5 8.6 21.9 12.5 35.2 6.9l235.5-99.7c3.8-1.6 7.2-3.9 10.2-6.8l397.2-397.2c28.1-28.1 28.3-73.9 0.2-102zM559.8 543l-137.4 58.2 58.2-137.4L759.4 185l79.2 79.2L559.8 543z m391.7-391.7l-62 62-79.2-79.2 62-62 0.2-0.2 79.2 79.2-0.2 0.2z" p-id="2921" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        ab00: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    use: "icon-lock-usage",
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-lock"><defs><style type="text/css"></style></defs><path d="M818.246893 412.326906l-45.988404 0 0-70.991868c0-152.307871-123.463939-275.778974-275.778974-275.778974s-275.78102 123.471103-275.78102 275.778974l0 70.991868-45.987381 0c-25.379017 0-45.988404 20.566408-45.988404 45.987381l0 455.407074c0 25.428136 20.560268 45.988404 45.988404 45.988404l643.535779 0c25.37697 0 45.988404-20.560268 45.988404-45.988404L864.235296 458.314287C864.190271 432.893314 843.623863 412.326906 818.246893 412.326906L818.246893 412.326906zM680.331823 412.326906 312.62516 412.326906l0-70.991868c0-101.55393 82.344426-183.853331 183.854355-183.853331 101.509928 0 183.853331 82.343403 183.853331 183.853331L680.332846 412.326906 680.331823 412.326906zM680.331823 412.326906" p-id="9663" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        ...
        b3b5: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    use: "icon-user-usage",
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-user"><defs><style type="text/css"></style></defs><path d="M504.951 511.98c93.49 0 169.28-74.002 169.28-165.26 0-91.276-75.79-165.248-169.28-165.248-93.486 0-169.287 73.972-169.279 165.248-0.001 91.258 75.793 165.26 169.28 165.26z m77.6 55.098H441.466c-120.767 0-218.678 95.564-218.678 213.45V794.3c0 48.183 97.911 48.229 218.678 48.229H582.55c120.754 0 218.66-1.78 218.66-48.229v-13.77c0-117.887-97.898-213.45-218.66-213.45z" p-id="7987" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        ...
        c829: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-chart"><defs><style type="text/css"></style></defs><path d="M64 448 320 448 320 960 64 960 64 448 64 448ZM704 256 960 256 960 960 704 960 704 256 704 256ZM384 64 640 64 640 960 384 960 384 64 384 64Z" p-id="10423" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        cbb7: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-email"><defs><style type="text/css"></style></defs><path d="M513 583.8l448.5-448.5c-11.6-4.7-24.3-7.3-37.5-7.3L100 128c-12.7 0-24.9 2.4-36.1 6.7L513 583.8z" p-id="9121" /><path d="M513 674.3 14.6 175.9C5.3 191.1 0 208.9 0 228l0 568c0 55.2 44.8 100 100 100l824 0c55.2 0 100-44.8 100-100l0-568c0-18.5-5.1-35.9-13.9-50.8L513 674.3z" p-id="9122" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        ...
        e534: function (t, e, n) {
            ...
            var i = n("e017"),
                ...
                a = new o.a({
                    ...
                    viewBox: "0 0 1024 1024",
                    content: '<symbol class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="icon-theme"><defs><style type="text/css"></style></defs><path d="M1004.094293 321.092267L762.737493 79.735467a68.266667 68.266667 0 0 0-96.546133 0l-30.293333 30.293333a68.283733 68.283733 0 0 1-48.264534 20.002133h-151.1936a68.181333 68.181333 0 0 1-48.264533-20.002133l-30.293333-30.293333a68.266667 68.266667 0 0 0-96.546134 0L19.962027 321.092267a68.266667 68.266667 0 0 0 0 96.546133l96.546133 96.546133a67.84 67.84 0 0 0 66.645333 17.271467c10.8032-3.072 21.674667 4.181333 21.674667 15.4112V896c0 37.546667 30.72 68.266667 68.266667 68.266667h477.866666c37.546667 0 68.266667-30.72 68.266667-68.266667V546.8672c0-11.229867 10.871467-18.4832 21.674667-15.4112a67.84 67.84 0 0 0 66.645333-17.271467l96.546133-96.546133a68.266667 68.266667 0 0 0 0-96.546133z" p-id="6549" /></symbol>'
                });
            s.a.add(a);
            e["default"] = a
        },
        ...
        ed08: function (t, e, n) {
            ...
            n("456d"), n("ac6a"), n("28a5"), n("4917"), n("6b54"), n("a481");
            var i = n("7618"),
                o = n("4360"),
                r = n("4ec3");
            ...
            function s(t, e) {
                ...
                "object" === Object(i["a"])(t) || 10 === ("" + t).length && (t = 1e3 * parseInt(t), t = +t), n = new Date(t);
                var r = {
                        y: n.getFullYear(),
                        m: n.getMonth() + 1,
                        d: n.getDate(),
                    ...
                    s = o.replace(/{(y|m|d|h|i|s|a|p)+}/g, (function (t, e) {
                        var n = r[e];
                        return "a" === e ? ["一", "二", "三", "四", "五", "六", "日"][n - 1] : (t.length > 0 && n < 10 && (n = "0" + n), n || 0)
                    }));
                return s
            }
            ...
            function a(t) {
                var e = "";
                if ("object" === Object(i["a"])(t)) try {
                    e = JSON.stringify(t), e = JSON.parse(e)
                } catch (n) {
                    e = t
                } else e = t;
                return e
            ...
            function c(t) {
                ...
                var e = Date.parse(new Date),
                    ...
                    s = parseInt(i / 30),
                    a = parseInt(s / 12);
                return a ? a + "年前" : s ? s + "个月前" : i ? i + "天前" : o ? o + "小时前" : r ? r + "分钟前" : "刚刚"
            }
            ...
            var p = function () {
                for (var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 100, e = [], n = 0; n < t; n++) e.push("");
                return e
            };
            ...
            function f(t) {
                ...
                return t > 1024 && n[e] ? f(t / 1024, n[e]) : (t || 0).toFixed(2).replace(".00", "") + e + "B"
            }

            function h(t, e) {
                var n = new Date,
                    i = new Date;
                t && (n = new Date(t)), e && (i = new Date(e));
                var o = i.getTime() - n.getTime(),
                    r = 0,
                    s = 0,
                    a = 0,
                    c = 0;
                return o >= 0 && (r = Math.floor(o / 1e3 / 3600 / 24), s = Math.floor(o / 1e3 / 60 / 60 % 24), a = Math.floor(o / 1e3 / 60 % 60), c = Math.floor(o / 1e3 % 60)), r + "天 " + s + "小时 " + a + "分钟 " + c + "秒"
            }
            ...
            function m(t) {
                ...
                if (t > -1) {
                    var n = Math.floor(t / 60) % 60,
                        i = t % 60;
                    i = Math.round(i), e = n < 10 ? "0" + n + ":" : n + ":", i < 10 && (e += "0"), e += i
                }
                return e
            }
            ...
            function w(t, e) {
                var n;
                t || e ? "[object Date]" !== Object.prototype.toString.call(t) && null !== t && "object" === Object(i["a"])(t) ? (e = t, n = new Date) : "[object Date]" === Object.prototype.toString.call(t) ? n = t : (10 === ("" + t).length && (t = 1e3 * parseInt(t)), t = +t, n = new Date(t)) : n = new Date, e = e || {};
                var o = {
                        start: 0,
                        end: 0
                    },
                    r = new Date(n).setHours(e.startHour || 0, e.startMin || 0, 0, 0),
                    s = new Date(n).setHours(e.endHour || 23, e.endMin || 59, 59, 0);
                return o.start = new Date(r).getTime(), o.end = new Date(s).getTime(), o
            }
            ...
            function g(t) {
                ...
                return e.forEach((function (t) {
                    ...
                    2 === e.length && e[0] && (n[e[0]] = e[1])
                })), n
            }

            function b(t, e) {
                e = e ? new Date(e) : new Date, t = new Date(t);
                var n = t.getFullYear(),
                    i = t.getMonth() + 1,
                    o = t.getDate(),
                    r = e.getFullYear(),
            ...
            function x() {
                var t = r["a"].hlsHref,
                    e = o["a"].getters.getConfig("HLS");
                return e && (e.ListenAddrTLS && "https:" === location.protocol ? t = location.protocol + "//" + location.hostname + e.ListenAddrTLS + "/hls/" : e.ListenAddr && (t = location.protocol + "//" + location.hostname + e.ListenAddr + "/hls/")), t
            }

            function y() {
                var t = r["a"].rtmpHref,
                    e = o["a"].getters.getConfig("RTMP");
                return e && e.ListenAddr && (t = "rtmp://" + location.hostname + e.ListenAddr + "/"), t
            }

            function M() {
                var t = r["a"].rtspHref,
                    e = o["a"].getters.getConfig("RTSP");
                return e && e.ListenAddr && (t = "rtsp://" + location.hostname + e.ListenAddr + "/"), t
            }

            function k() {
                var t = r["a"].hdlHref,
                    e = o["a"].getters.getConfig("HDL");
                return e && (e.ListenAddrTLS && "https:" === location.protocol ? t = location.protocol + "//" + location.hostname + e.ListenAddrTLS + "/hdl/" : e.ListenAddr && (t = location.protocol + "//" + location.hostname + e.ListenAddr + "/hdl/")), t
            }

            function C() {
                var t = r["a"].jessibucaHref,
                    e = o["a"].getters.getConfig("Jessica");
                return e && (e.ListenAddrTLS && "https:" === location.protocol ? t = "wss://" + location.hostname + e.ListenAddrTLS + "/jessica/" : e.ListenAddr && (t = "ws://" + location.hostname + e.ListenAddr + "/jessica/")), t
            }

            function L() {
                var t = r["a"].recordHref,
                    e = o["a"].getters.getConfig("GateWay");
                return e && (e.ListenAddrTLS && "https:" === location.protocol ? t = location.protocol + "//" + location.hostname + e.ListenAddrTLS + "/vod/" : e.ListenAddr && (t = location.protocol + "//" + location.hostname + e.ListenAddr + "/vod/")), t
            }
            ...
            function _() {
                for (var t = [], e = 0; e < 16; e++) t.push(null);
                return t
            }
        },
        f782: function (t, e, n) {
